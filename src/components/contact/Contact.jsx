        ...
        >
            <motion.div variants={variants} className="textContainer">
                ...
                <motion.div variants={variants} className="item">
                    <h2>Email</h2>
                    <span>guilhermebastosleone@gmail.com</span>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Telefone</h2>
                    <span>(19) 971423178</span>
                </motion.div>
            </motion.div>
            ...
            C32.666,7.326,25.339,0,16.333,0z"
                ...
                >
                    ...
                    <textarea name='message' rows={8} placeholder='Menssagem' />
                    <button>Enviar</button>
                    {error && <span className='error'>Erro ao enviar a mensagem</span>}
